...
const DATABASE = {
    ...
    addIntentionTimer(projectKey, intentionIndex, intentionName, timerNote, callback) {
        const userid = firebase.auth().currentUser.uid;

        const newTimerNoteId = firebase.database().ref().child('/timerNotes/' + userid + '/' + projectKey + '/' + intentionIndex).push().key;

        let updateObj = {
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/startTime']: timerNote.startTime,
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/endTime']: timerNote.endTime,
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/noteContent']: timerNote.note,
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/focusedTime']: timerNote.focusedTime,
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/intentionIndex']: intentionIndex,
            ['/timerNotes/' + userid + '/' + projectKey + '/' + newTimerNoteId + '/intentionName']: intentionName
        };
    ...
    /*
     * @description - Gets all of the timer notes associated with a particular project.
     * @param: projectKey:String - The key of the project
     * @return */
    getProjectTimerNotes(projectKey, callback) {
        const userid = firebase.auth().currentUser.uid;
        
        firebase.database().ref('timerNotes/' + userid + "/" + projectKey).once('value', function (snapshot) {

            let timerNotes = snapshot.val();
